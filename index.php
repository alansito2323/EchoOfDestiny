...
<html lang="en">
  ...
  <head>
    ...
    <meta name="theme-color" content="#8F20B4">
  ...
  <link rel="apple-touch-startup-image" href="assets/images/logo1024.jpg">
            ...
            <div class="row">
              <div class="col-lg-7">
                <div class="header-text">
                  <h6>Welcome To Dead Pixels</h6>
                  <h4><em>Discover </em> Echos of Destiny</h4>
                  <h3>Embark on an unforgettable adventure with "Echos of Destiny". Join now and dive into the experience!</h3>
                  <div class="main-button" style="margin-top: 32px;">
...
<div class="gaming-library">
  <div class="col-lg-12">
    <div class="heading-section">
      <h4><em>Levels</em> Current Adventures</h4>
    </div>
    <div class="item">
      <ul>
        ...
        <li><h4>Difficult</h4><span>Easy</span></li>
        <li><span class="update-date"><i class="fa fa-calendar"></i> Updated: Nov 2024</span></li>
    ...
    <div class="item">
      <ul>
        ...
        <li><h4>Difficult</h4><span>Medium</span></li>
        <li><span class="update-date"><i class="fa fa-calendar"></i> Updated: Nov 2024</span></li>
      </ul>
    </div>
